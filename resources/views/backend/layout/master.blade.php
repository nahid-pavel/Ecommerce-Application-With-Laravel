        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#menu-products" aria-expanded="false"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#menu-category" aria-expanded="false"
                            aria-controls="ui-basic">
                            <i class="menu-icon typcn typcn-coffee"></i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#menu-brand" aria-expanded="false"
                            aria-controls="ui-basic">
                            <i class="menu-icon typcn typcn-coffee"></i>
                            <span class="menu-title">Manage Brands</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="menu-brand">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
